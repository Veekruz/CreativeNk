...
const photos = [
  ...
  },
  {
    ...
    title: "The Yoruba Chief",
    loc: "Ife, Osun",
    cat: "portrait",
  },
  {
    src: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80",
    title: "Morning in Onitsha",
    loc: "Onitsha, Anambra",
    cat: "lifestyle",
  },
  {
...
const testimonialsData = [
  {
    text: "CREATIVENK captured our traditional wedding in a way that brought tears to my mother's eyes. Every frame tells our love story with such authenticity and beauty. The best photographer in Lagos, no contest!",
    avatar:
      "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80",
    name: "Chidinma Adewale",
    role: "Wedding Client · Lagos, Nigeria",
  },
  {
    text: "Working with CREATIVENK on our Aso-Ebi campaign was pure magic. They understand Nigerian fashion at its core — the colours, the fabrics, the culture. Our brand has never looked this good.",
    avatar:
      "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80",
    name: "Emeka Okafor",
    role: "Creative Director · House of Adire",
  },
  {
    text: "I've worked with photographers across Africa, but CREATIVENK's ability to make you feel completely at ease while delivering world-class portraits is unmatched. My corporate headshots have never received so many compliments.",
    avatar:
      "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&q=80",
    name: "Amina Bello",
    role: "CEO · Abuja, Nigeria",
  },
  {
    text: "Our product launch in Victoria Island was documented with such sophistication. Every image felt like a magazine editorial. We've found our forever photography partner.",
    avatar:
      "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&q=80",
    name: "Tunde Bakare",
    role: "Founder · Lagos Luxury Collective",
  },
];
    ...
    <>
      ...
      <div
        ...
        style={{
          left: cursorPos.x,
          top: cursorPos.y,
          width: cursorHover ? "6px" : "12px",
          height: cursorHover ? "6px" : "12px",
        }}
      />
      <div
        ref={cursorRingRef}
        ...
        style={{
          left: ringPos.x,
          top: ringPos.y,
          width: cursorHover ? "60px" : "40px",
          height: cursorHover ? "60px" : "40px",
      ...
      <section id="hero">
        ...
        <div className="hero-content">
          <div className="hero-label">Award-winning Nigerian Photography</div>
          <h1 className="hero-title">
            Capturing <em>Stories</em>
            <br />
            Beyond The Lens
          </h1>
          <p className="hero-sub">
            Fashion &nbsp;·&nbsp; Weddings &nbsp;·&nbsp; Portraits &nbsp;·&nbsp;
            Editorial
          </p>
      ...
      >
        ...
        <div id="lightbox-prev" onClick={prevLightbox}>
          <IconChevronLeft />
        </div>
        <img
          ...
          id="lightbox-img"
        />
        <div id="lightbox-next" onClick={nextLightbox}>
          <IconChevronRight />
        </div>
      </div>
          ...
          <div className="about-grid">
            <div className="about-image-wrap reveal-left">
              <img
                ...
                alt="CREATIVENK — Nigerian Photographer"
              />
            ...
            <div className="about-text reveal-right">
              ...
              <h2 className="section-title">
                A Vision
                <br />
                Rooted in <em>Culture</em>
              </h2>
              <p className="about-bio">
                "Photography is not about the camera. It's about preserving our
                stories, our heritage, and our vibrant Nigerian spirit in a
                single frame."
              </p>
              <p className="about-body">
                Based between Uyo and Lagos, CREATIVENK has spent nearly a
                decade documenting Nigeria's most beautiful moments, from royal
                traditional weddings in Benin to high-fashion editorials on Ibom
                Resorts. Our work has been featured in Genevieve Magazine,
                ThisDay Style, and BellaNaija.
              </p>
              <p className="about-body">
                With a deep understanding of Nigerian culture and a contemporary
                artistic eye, we approach every session as a collaboration,
                honouring tradition while creating timeless, world-class
                imagery.
              </p>
              <div className="about-stats">
                <div className="stat-item">
                  <div className="stat-num counter" data-target="8">
                    0
                  </div>
                  <div className="stat-label">Years Active</div>
                </div>
                <div className="stat-item">
                  <div className="stat-num counter" data-target="620">
                    0
                  </div>
                  <div className="stat-label">Sessions Done</div>
                </div>
                <div className="stat-item">
                  <div className="stat-num counter" data-target="24">
                    0
                  </div>
              ...
              <div className="brands-row">
                <span className="brand-name">Genevieve</span>
                <span className="brand-name">ThisDay</span>
                <span className="brand-name">BellaNaija</span>
                <span className="brand-name">Arise</span>
                <span className="brand-name">Vogue</span>
              </div>
            ...
            {[
              {
                ...
                desc: "From traditional engagements to white weddings, we capture every tear, dance, and spray of Naira with cinematic excellence.",
                price: "Starting from ₦850,000",
              },
              {
                Icon: IconFashion,
                name: "Fashion Photography",
                desc: "Editorial and commercial fashion for Nigerian brands, Ankara, Adire, and contemporary designs shot with global standards.",
                price: "Starting from ₦450,000",
              },
              {
                Icon: IconEvent,
                name: "Event Coverage",
                desc: "Owambe parties, corporate launches, and red-carpet galas captured with the editorial eye your event deserves.",
                price: "Starting from ₦550,000",
              },
              {
                Icon: IconPortrait,
                name: "Studio Portraits",
                desc: "Professional headshots, creative portraits, and family sessions in our fully-equipped Lekki studio.",
                price: "Starting from ₦200,000",
              },
              {
                Icon: IconProduct,
                name: "Product Photography",
                desc: "Premium product imagery for Nigerian beauty, fashion, and lifestyle brands that demand visual perfection.",
                price: "Starting from ₦300,000",
              },
              {
                Icon: IconCreative,
                name: "Creative Direction",
                desc: "Full creative direction for campaigns and brand identity, from concept moodboards to final delivery.",
        ...
        <div className="container">
          ...
          <div className="testi-track-wrap">
            <div
              ...
              ref={testiTrackRef}
              style={{
                transform: `translateX(-${testiPos * getTestiSlideWidth()}px)`,
              }}
            >
        ...
        <div className="container">
          ...
          <div className="pricing-grid">
            {[
              ...
              <div
                key={index}
                className={`pricing-card ${plan.featured ? "featured" : ""} reveal delay-${index + 1}`}
              >
                {plan.featured && (
        ...
        <div className="container">
          <div className="booking-grid">
            <div className="reveal-left">
              ...
              >
                Every great photograph begins with a conversation. Share your
                vision, and together we'll create images that honour your story
              ...
              <div className="contact-item">
                ...
                <div className="contact-text">
                  <strong>Email</strong>hello@creativenk.ng
                </div>
              </div>
              <div className="contact-item">
                <span className="contact-icon">
                ...
                <div className="contact-text">
                  <strong>Studio</strong>Plot 12, Admiralty Way, Lekki Phase 1,
                  Lagos &amp; 45 Nwaniba Road, Uyo, Akwa Ibom
                </div>
              </div>
              <div className="contact-item">
                <span className="contact-icon">
                ...
                <div className="contact-text">
                  <strong>Availability</strong>Booking 2–4 months in advance.
                  Limited sessions per month. Available nationwide.
                </div>
              </div>
            </div>
              ...
              {!formSubmitted ? (
                ...
                >
                  ...
                  <div className="form-group">
                    ...
                    <textarea
                      id="fmsg"
                      placeholder="Describe your project, location, inspiration, and any special requests... Include your city if outside Lagos."
                      value={formData.fmsg}
                      onChange={handleFormChange}
                    />
                  </div>
                ...
                <div className="form-success" style={{ display: "block" }}>
                  ...
                  <h3>
                    Daalụ! Thank You,{" "}
                    <span>{formName || "Beautiful Soul"}</span>
                  </h3>
                  <p>
                    Your enquiry has been received. CREATIVENK will be in touch
                    within 24 hours. We can't wait to create magic with you!
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="container">
          <div className="insta-header reveal">
            <div>
              ...
              <div className="insta-handle">@creativenk36</div>
            </div>
            <div className="insta-stats">
              {[
                { strong: "2.7K", span: "Followers" },
                { strong: "1.2K", span: "Posts" },
                { strong: "96%", span: "Engagement" },
              ].map((stat, i) => (
                <div key={i} className={`insta-stat reveal delay-${i + 1}`}>
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <p>
                Premium photography &amp; visual storytelling studio based in
                Akwa Ibom, Lagos and Abuja. Capturing Nigeria's most beautiful
            ...
            <div className="footer-col">
              ...
              >
                Subscribe for behind-the-scenes, new work, and occasional
                thoughts on light, culture, and creativity.
              </p>
          ...
          <div className="footer-bottom">
            <div className="footer-copy">
              &copy; 2026 CREATIVENK Photography. All rights reserved.
            </div>
            <div className="footer-copy" style={{ letterSpacing: "0.05em" }}>
              Akwa Ibom · Abuja · Lagos · Available Nationwide 🇳🇬
            </div>
          </div>
        </div>
      </footer>
